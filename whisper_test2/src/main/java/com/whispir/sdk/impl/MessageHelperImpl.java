...
public class MessageHelperImpl extends BaseHelperImpl implements MessageHelper {
  ...
  public WhispirResponse sendMessage(String workspaceId, String recipient,
    ...
    try {
      ...
      // Check for the templateId in the map
      if (content.containsKey("templateId") && !"".equals(content.get("templateId"))) {
        request.put("messageTemplateId", content.get("templateId"));
      }
      ...
      if (options.containsKey(WhispirSDKConstants.PUSH_NOTIFICATIONS)
          && WhispirSDKConstants.PUSH_NOTIFICATIONS_ENABLED.equalsIgnoreCase(options
              .get(WhispirSDKConstants.PUSH_NOTIFICATIONS))) {
      ...
      System.out.println("Whispir request: " + request.toString());
